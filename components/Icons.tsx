...
// Added React.FC typing to ensure icon components support standard attributes like 'key' in mapped arrays.
export const PianoIcon: React.FC<{ className?: string }> = ({ className }) => (
